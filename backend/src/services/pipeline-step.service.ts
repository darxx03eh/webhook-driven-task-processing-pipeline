...
export const createPipelineStepService = async (
  input: CreatePipelineStepInput,
) => {
  const pipeline = await findPipelineOwnedByUser(
    input.pipelineId,
    input.userId,
  );
  if (!pipeline)
...
export const getPipelineStepsService = async (
  pipelineId: string,
  userId: string,
) => {
...
export const updatePipelineStepService = async (
...
export const deletePipelineStepService = async (
  stepId: string,
  userId: string,
) => {
